...
public class FormLogin extends javax.swing.JDialog {
    ...
    private void cek_login(){
        try {
            db.rs= db.stmt.executeQuery("select * from akun_admin where username='"+jTextUsername.getText()+"'");
            if(db.rs.next()){
                if(jPasswordField1.getText().equals(db.rs.getString("password"))){
                    JOptionPane.showMessageDialog(rootPane, "Selamat datang "+jTextUsername.getText());
                    this.dispose();
                }else{
